...
4. [clone repository](git@github.com:Yemisirach/todo-list-react.git)

```bash
$ git clone git@github.com:Yemisirach/todo-list-react.gitd
```
...
[Issue page](https://github.com/Yemisirach/todo-list-react/issues)
